    ...
    <div className="px-4 py-10 md:px-10 flex-1">
      ...
      <form onSubmit={onHandleSumbit} className="flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col w-full">
              <label>Year</label>
              <input type="number" placeholder={new Date().getFullYear()} min={1990} max={new Date().getFullYear()} required  className="px-3 py-2 mt-1 border border-borderColor rounded-md outline-none " value={car.year} onChange={(e) => setCar({...car , year : e.target.value})}/>
          </div>

          <div className="flex flex-col w-full">
              <label>Daily Price ({currency})</label>
              <input type="number" placeholder="100" min={50}  required  className="px-3 py-2 mt-1 border border-borderColor rounded-md outline-none " value={car.pricePerDay} onChange={(e) => setCar({...car , pricePerDay : e.target.value})}/>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col w-full">
              ...
              <input type="number" placeholder="4" min={2} required  className="px-3 py-2 mt-1 border border-borderColor rounded-md outline-none " value={car.seating_capacity} onChange={(e) => setCar({...car , seating_capacity : e.target.value})}/>
          </div>
        </div>
        ...
        <div className="flex flex-col w-full">
            ...
            <textarea rows={5}  placeholder="Enter car description..." required className="px-3 py-2 mt-1 border border-borderColor rounded-md outline-none " value={car.description} onChange={(e) => setCar({...car , description : e.target.value})}></textarea>
        </div>
